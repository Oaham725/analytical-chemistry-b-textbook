...
const books=[{file:'index',short:'01',title:'绪论',desc:'生命科学中的化学测量与证据'},{file:'chapter2',short:'02',title:'误差、有效数字与数据处理',desc:'从原始读数到统计判断与可靠表达'},{file:'extension',short:'拓展',title:'化学计量学与 AI',desc:'从单个数字到多变量模型'},{file:'references',short:'文献',title:'参考文献与阅读指南',desc:'书籍、原始研究与计量规范'}];
...
for(const [index,book]of books.entries()){
 ...
 fs.writeFileSync(`docs/${book.file}.html`,result.replace('第一卷 · 绪论与有效数字','第一卷 · 绪论与分析数据').replace('教学编写版 · 2026 年 9 月','教学编写版 · 2026 年 9 月 18 日修订'));
